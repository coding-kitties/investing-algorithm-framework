...
//  baseUrl: '/',
  ...
  organizationName: 'coding-kitties', // Usually your GitHub org/user name.
  projectName: 'investing-algorithm-framework', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Investing algorithm framework',
        logo: {
          alt: 'Coding Kitties Logo',
          src: 'img/coding-kitties.svg',
        },
        items: [
          {
            type: 'docSidebar',
            ...
            items: [
              {
                ...
                href: 'https://stackoverflow.com/questions/tagged/investing-algorithm-framework',
              },
            ],
          },
          {
