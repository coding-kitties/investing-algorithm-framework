...
class SQLTradeTakeProfit(
    ...
    mirror_on_exchange = Column(Boolean, default=False)
    mirror_order_id = Column(String, default=None)
    mirror_triggered = Column(Boolean, default=False)
    mirror_triggered_at = Column(DateTime, default=None)
