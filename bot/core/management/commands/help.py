...
from bot.core.management import BaseCommand
from bot.core.management.utils import get_commands
from bot.core.configuration.config_constants import FRAMEWORK_CORE_MODULE_NAME, FRAMEWORK_NAME
...
class HelpCommand(BaseCommand):
    ...
    def handle(self) -> Any:
        usage = [
            "",
            "This is the command line management for the investing bot framework. \n"
