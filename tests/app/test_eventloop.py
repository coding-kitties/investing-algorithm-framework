...
class TestEventloopService(TestBase):
    ...
    # ------------------------------------------------------------------
    # The following backtest tests remain commented out because they
    # depend on CCXTOHLCVDataProvider.prepare_backtest_data() which
    # downloads live OHLCV data from the Bitvavo exchange. They cannot
    # run in CI or without network access to the exchange API.
    # ------------------------------------------------------------------
