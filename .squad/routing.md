...
|-----------|----------|----------|
| Architecture & design | Burry | Framework design, domain model, public API changes |
| Framework internals | Baum | Feature implementation, bug fixes, refactoring |
| Trading domain logic | Baum | Strategy patterns, order execution, portfolio management |
| Code review | Burry | Review PRs, check quality, suggest improvements |
| Testing | Vennett | Write tests, find edge cases, verify fixes |
| Scope & priorities | Burry | What to build next, trade-offs, decisions |
